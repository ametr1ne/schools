...
var parallax6 = $(".parallax6");
var parallax7 = $(".block20__parallax");
var block2 = $(".block2__container");
var block3 = $(".block3");
var block5 = $(".block5");
var block7 = $(".block20__parallax-wrap");
var block10 = $(".block10");
...
window.addEventListener('scroll', function () {
    ...
    if (scroll < 900) {
        parallax.each(function (element) {
            ...
            $(this).css("transform", "translateY(" + parseInt(scroll * speed / 2) + "px)");
        });
    }

    var block2Bounds;
    if (block2.length) {
        block2Bounds = block2[0].getBoundingClientRect();
        if (block2Bounds.top < 1100 && block2Bounds.top > -800 && width > 767) {
            parallax2.each(function (element) {
                var speed = $(this).data('speed');
                $(this).css("transform", "translateY(" + parseInt(block2Bounds.top * speed / 2) + "px)");
            });
        }
    }
    ...
    var block3Bounds;
    if (block3.length) {
        block3Bounds = block3[0].getBoundingClientRect();
        if (block3Bounds.top < 700 && block3Bounds.top > -900 && width > 767) {
            parallax3.each(function (element) {
                var speed = $(this).data('speed');
                $(this).css("transform", "translateY(" + parseInt(block3Bounds.top * speed) + "px)");
            });
        }
    }
    ...
    var block5Bounds;
    if (block5.length) {
        block5Bounds = block5[0].getBoundingClientRect();
        if (block5Bounds.top < 1300 && block5Bounds.top > -800 && width > 767) {
            parallax5.each(function (element) {
                var speed = $(this).data('speed');
                $(this).css("transform", "translateX(" + parseInt(block5Bounds.top * speed - 700) + "px)");
            });
        }
    }
    ...
    var block7Bounds;
    if (block7.length) {
        block7Bounds = block7[0].getBoundingClientRect();
        if (block7Bounds.top < 1100 && block7Bounds.top > -800 && width > 767) {
            parallax7.each(function (element) {
                var speed = $(this).data('speed');
                $(this).css("transform", "translateX(" + parseInt(block7Bounds.top * speed - 700) + "px)");
            });
        }
    }
    ...
    var block10Bounds;
    if (block10.length) {
        block10Bounds = block10[0].getBoundingClientRect();
        if (block10Bounds.top < 1100 && block10Bounds.top > -850 && width > 767) {
            parallax6.each(function (element) {
                var speed = $(this).data('speed');
                $(this).css("transform", "translateY(" + parseInt(block10Bounds.top * speed) + "px)");
            });
        }
    }
});
...
function resizeList() {
    ...
    if (window.matchMedia('(min-width: 768px)').matches) {
        $('.block6__program-item .body').css('max-height', 'unset')
    }

    if (window.matchMedia('(max-width: 767px)').matches) {
        $('.block6__program-item .body').css('max-height', '0')
